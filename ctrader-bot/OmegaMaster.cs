...
namespace cAlgo.Robots
{
    ...
    public class OmegaMaster : Robot
    {
        ...
        protected override void OnStart()
        {
            ...
            Print("========================================");
            Print("OMEGA MASTER — MULTI-STRATEGY");
            Print("========================================");
        ...
        private void ExecuteTrade(Setup setup)
        {
            ...
            var result = ExecuteMarketOrder(setup.Direction, SymbolName, volume, "Master", setup.Stop, setup.Take);
        ...
        {
            Print(string.Format("MASTER STOPPED — Trades: {0}", _tradeCount));
        }
